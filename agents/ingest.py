...
class IngestAgent(BaseAgent):
    ...
    def _validate_paper_content(self, paper_content: PaperContent) -> None:
        ...
        if not paper_content.abstract or len(paper_content.abstract.strip()) < 20:
            self.logger.warning("Abstract is missing or very short")
        ...
        if total_content_length < 500:  # Minimum reasonable paper length
            raise AgentExecutionError(
                "Paper content is too short",
