...
class RenderedScene(BaseModel):
    ...
    def validate_file_path(cls, v):
        ...
        # Check for valid video extensions or content files
        valid_extensions = [".mp4", ".mov", ".avi", ".mkv", ".webm", ".txt"]
        path = Path(v)
    ...
    def validate_framework(cls, v):
        ...
        valid_frameworks = ["manim", "motion-canvas", "remotion", "python_video", "ffmpeg_fallback", "content_description"]
